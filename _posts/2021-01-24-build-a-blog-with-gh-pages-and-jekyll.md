...
## 内容提要
- [使用Github Pages及Jekyll建立基础功能博客站点](#使用github-pages及jekyll建立基础功能博客站点)
- [更改Jekyll主题](#更改jekyll主题)
- [Jekyll中的Markdown语法](#jekyll中的markdown语法)
	- [文本格式](#文本格式)
	- [标题等级](#标题等级)
	- [书写行内代码](#书写行内代码)
	- [引用](#引用)
	...
	- [超链接](#超链接)
	- [图片插入](#图片插入)
	- [临时禁止Jekyll tag命令](#临时禁止jekyll-tag命令)
	- [锚点连接](#锚点连接)
...
注意，在圆括号“()”内的锚点目标，需将大写字母都改为小写，空格需使用“-”符合替代。方括号“[]”内的内容及原有的各级标题形式无需修改。但各级标题需要与圆括号中的锚点目标一致，方括号中为链接的显示内容，可不一致。
